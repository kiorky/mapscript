...
class labelCacheMemberObj(_object):
    ...
    if _newclass:labelpath = _swig_property(_mapscript.labelCacheMemberObj_labelpath_get)
    def __init__(self, *args): 
...
class mapObj(_object):
    ...
    if _newclass:saved_extent = _swig_property(_mapscript.mapObj_saved_extent_get, _mapscript.mapObj_saved_extent_set)
...
class imageObj(_object):
    ...
    __swig_getmethods__["imageextra"] = _mapscript.imageObj_imageextra_get
    if _newclass:imageextra = _swig_property(_mapscript.imageObj_imageextra_get)
    ...
    if _newclass:size = _swig_property(_mapscript.imageObj_size_get, _mapscript.imageObj_size_set)
